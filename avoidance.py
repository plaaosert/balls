# avoidance. all balls start in the centre and try to move away from all other balls.
# heuristic is used to score which movement is best
...
render.draw_frames(board, 4, "out.gif", 1000)
